 ...
 */
public class MapActivity_rider_2 extends AppCompatActivity implements
        OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,
        com.google.android.gms.location.LocationListener, GoogleMap.OnMarkerDragListener,TaskLoadedCallback
{

    private static final String TAG = MapActivity_rider_2.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_rider2);
        ...
        if(ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(MapActivity_rider_2.this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_REQUEST_CODE);
...
//                    Toast.makeText(MapActivity_rider_2.this, "Please input locations", Toast.LENGTH_SHORT).show();
//                } else {
...
//
//                    //加一个activity
//                    Intent intent = new Intent(MapActivity_rider_2.this, RiderAddMoneyFragmentActivity3.class);
//                    intent.putExtra("trip_location",loc1);
//                    intent.putExtra("trip_destination",loc2);
//                    intent.putExtra("startLocationLat",Marker1.getPosition().latitude);
//                    intent.putExtra("startLocationLng",Marker1.getPosition().longitude);
//                    intent.putExtra("endLocationLat",Marker2.getPosition().latitude);
//                    intent.putExtra("endLocationLng",Marker2.getPosition().longitude);
//                    intent.putExtra("cost",money);
...
//
        ...
        if ((userAddress1 != null) && (userAddress2 != null)) {
            ...
            new FetchURL(MapActivity_rider_2.this).execute(url, "driving");
        }
...
//
//        Intent i = new Intent(MapActivity_rider_2.this, RiderMakeRequestActivity.class);
//
//        i.putExtras(extras);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(MapActivity_rider_2.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
